...
/**
 * InputMethodSettingsInterface is the interface for adding IME related
 * preferences to PreferenceActivity or PreferenceFragment.
 */
public interface InputMethodSettingsInterface {
    /**
     * Sets the title for the input method settings category with a
     * CharSequence.
     * 
    ...
    /**
     * Sets the icon for the Preference for launching subtype enabler with a
     * Drawable.
     * 
    ...
    /**
     * Sets the title for the input method enabler preference for launching
     * subtype enabler with a CharSequence.
     * 
     * @param title The title for this preference.
     */
    ...
    /**
     * Sets the title for the input method enabler preference for launching
     * subtype enabler with a resource ID.
     * 
     * @param resId The resource ID of the title.
     */
